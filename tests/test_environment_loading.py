...
class TestEnvironmentLoading:
    ...
    def test_get_github_client_with_valid_token(self):
        ...
        with patch.dict(os.environ, {"GITHUB_TOKEN": "github_pat_1234567890"}, clear=False):
    ...
    def test_get_github_client_with_empty_token(self):
        ...
        with patch.dict(os.environ, {"GITHUB_TOKEN": ""}, clear=False):
            with pytest.raises(Exception, match="GITHUB_TOKEN environment variable not set"):
                get_github_client()
    ...
    def test_get_github_client_with_invalid_format(self):
        ...
        with patch.dict(os.environ, {"GITHUB_TOKEN": "invalid_token_format"}, clear=False):
            with pytest.raises(Exception, match="GITHUB_TOKEN appears to be invalid format"):
                get_github_client()
    ...
    def test_environment_loading_precedence(self, tmp_path):
        ...
        project_env.write_text("GITHUB_TOKEN=project_token\nPROJECT_VAR=project_value\n")
