"""GitHub domain tool registration for lean MCP interface."""
...
from ..github.models import (
    GitHubAddPRComment,
    GitHubAwaitWorkflowCompletion,
    GitHubBulkUpdateIssues,
    GitHubClosePR,
    GitHubConvertPRToDraft,
    GitHubCreateIssue,
    ...
    GitHubListCodeScanningAlerts,
    GitHubListCodeScanningAnalyses,
    GitHubListIssues,
...
def _register_github_tools(interface: Any, github_service: Any):
    ...
    github_tools = [
        ...
        ToolDefinition(
            ...
            implementation=github_ops.github_get_pr_diff,
            description="Get the unified diff of a pull request (actual changed lines, not just file counts)",
            schema=GitHubGetPRDiff.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        ToolDefinition(
        ...
        ToolDefinition(
            ...
            schema=GitHubCreatePR.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        ToolDefinition(
            name="github_mark_pr_ready",
            implementation=github_ops.github_mark_pr_ready,
            description="Mark a draft pull request as ready for review (GraphQL-only operation)",
            schema=GitHubMarkPRReady.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        ToolDefinition(
            name="github_convert_pr_to_draft",
            implementation=github_ops.github_convert_pr_to_draft,
            description="Convert a ready pull request back to draft (GraphQL-only operation)",
            schema=GitHubConvertPRToDraft.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        ToolDefinition(
            ...
            schema=GitHubMergePR.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        ToolDefinition(
            ...
            schema=GitHubAddPRComment.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        ToolDefinition(
            ...
            schema=GitHubGetPRComments.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        ToolDefinition(
            ...
            schema=GitHubGetPRReviews.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        ToolDefinition(
            ...
            schema=GitHubReplyToPRComment.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        ToolDefinition(
            ...
            schema=GitHubClosePR.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        ToolDefinition(
            ...
            schema=GitHubReopenPR.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        ToolDefinition(
            ...
            schema=GitHubUpdatePR.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        ToolDefinition(
            ...
            schema=GitHubAwaitWorkflowCompletion.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        ...
        # GHAS Forensics — Rulesets (Issue #186)
        ToolDefinition(
            name="github_list_rulesets",
            implementation=github_ops.github_list_rulesets,
            description="List rulesets defined on a repository (complements classic branch protection)",
            schema=GitHubListRulesets.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        ToolDefinition(
            name="github_get_ruleset",
            implementation=github_ops.github_get_ruleset,
            description="Get a specific ruleset by ID including required_status_checks, code_scanning rules, and bypass actors",
            schema=GitHubGetRuleset.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        ToolDefinition(
            name="github_get_branch_rules",
            implementation=github_ops.github_get_branch_rules,
            description="Get all rules (classic + ruleset-based) that apply to a branch",
            schema=GitHubGetBranchRules.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        # GHAS Forensics — Code Scanning (Issue #186)
        ToolDefinition(
            name="github_list_code_scanning_alerts",
            implementation=github_ops.github_list_code_scanning_alerts,
            description="List code scanning alerts with optional state/severity/tool/ref filters",
            schema=GitHubListCodeScanningAlerts.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        ToolDefinition(
            name="github_list_code_scanning_analyses",
            implementation=github_ops.github_list_code_scanning_analyses,
            description="List code scanning analyses for a repository, filterable by ref and tool",
            schema=GitHubListCodeScanningAnalyses.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        ToolDefinition(
            name="github_get_code_scanning_default_setup",
            implementation=github_ops.github_get_code_scanning_default_setup,
            description="Get the default-setup configuration for code scanning (languages, query suite, schedule)",
            schema=GitHubGetCodeScanningDefaultSetup.model_json_schema(),
            domain="github",
            complexity="focused",
        ),
        # GHAS Forensics — Secret Scanning (Issue #186)
        ToolDefinition(
            name="github_list_secret_scanning_alerts",
            implementation=github_ops.github_list_secret_scanning_alerts,
            description="List secret scanning alerts for a repository with optional state filter",
