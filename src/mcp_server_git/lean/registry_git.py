...
def _register_git_tools(interface: Any, git_service: Any):
    ...
    git_tools = [
        ...
        ToolDefinition(
            name="git_update_index",
            implementation=wrap_repo_op(git_ops.git_update_index, mutates_index=True),
            description="Sets or clears the executable bit recorded in the git index (--chmod=+x/-x)",
            schema=GitUpdateIndex.model_json_schema(),
            domain="git",
            complexity="core",
        ),
        ToolDefinition(
            name="git_ls_files",
            implementation=wrap_repo_op(git_ops.git_ls_files),
            description="Lists files tracked by git, optionally showing the index mode via -s",
            schema=GitLsFiles.model_json_schema(),
            domain="git",
            complexity="core",
        ),
        ToolDefinition(
        ...
        ToolDefinition(
            ...
            schema=GitFetch.model_json_schema(),
            domain="git",
            complexity="core",
        ),
        ToolDefinition(
            ...
            schema=GitRemoteAdd.model_json_schema(),
            domain="git",
            complexity="core",
        ),
        ToolDefinition(
            ...
            schema=GitRemoteRemove.model_json_schema(),
            domain="git",
            complexity="core",
        ),
        ToolDefinition(
            ...
            schema=GitRemoteList.model_json_schema(),
            domain="git",
            complexity="core",
        ),
        ToolDefinition(
            ...
            schema=GitRemoteGetUrl.model_json_schema(),
            domain="git",
            complexity="core",
        ),
        ToolDefinition(
        ...
        ToolDefinition(
            ...
            schema=GitStashList.model_json_schema(),
            domain="git",
            complexity="core",
        ),
        ToolDefinition(
            ...
            schema=GitStashPush.model_json_schema(),
            domain="git",
            complexity="core",
        ),
        ToolDefinition(
            ...
            schema=GitStashPop.model_json_schema(),
            domain="git",
            complexity="core",
        ),
        ToolDefinition(
            ...
            schema=GitStashDrop.model_json_schema(),
            domain="git",
            complexity="core",
        ),
