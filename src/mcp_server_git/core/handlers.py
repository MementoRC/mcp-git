...
class CallToolHandler:
    ...
    def _get_github_handlers(self) -> Dict[str, Any]:
        ...
        return {
            ...
            # GitHub Repository Settings Management Handlers
            "github_repo_settings": self._create_github_handler(
                github_repo_settings,
                [
                    "repo_owner",
                    "repo_name",
            ...
            "github_actions_settings": self._create_github_handler(
                github_actions_settings,
                [
                    "repo_owner",
                    "repo_name",
            ...
            "github_workflow_permissions": self._create_github_handler(
                github_workflow_permissions,
                [
                    "repo_owner",
                    "repo_name",
            ...
            "github_branch_protection": self._create_github_handler(
                github_branch_protection,
                [
                    "repo_owner",
                    "repo_name",
            ...
            "github_security_settings": self._create_github_handler(
                github_security_settings,
                [
                    "repo_owner",
                    "repo_name",
