...
@click.option("--enable-file-logging", is_flag=True, help="Enable logging to file in logs/ directory")
def main(repository: Path | None, verbose: bool, enable_file_logging: bool) -> None:
    ...
    if enable_file_logging:
        ...
        session_id = os.environ.get("MCP_SESSION_ID", datetime.now().strftime("%Y%m%d_%H%M%S"))
