...
async def test_github_write_operations():
    ...
    # Test both monolithic and modular versions
    implementations = [("Monolithic", monolithic_github_add_pr_comment, monolithic_github_update_pr)]
    if HAS_MODULAR:
        implementations.append(("Modular", modular_github_add_pr_comment, modular_github_update_pr))
